...
const FAQComponent = ({que="",ans="", isOpen, onToggle}) => {
  return (
    <div onClick={onToggle} 
        ...
        <div className={`w-[22px] sm:w-[32px] h-[22px] sm:h-[32px] flex justify-center items-center bg-[#FF624C] border border-[#FF624C] rounded-full absolute top-[36px] sm:top-8 left-3 sm:left-12 ${isOpen && 'bg-white'} duration-200`}>
