...
import BottomBarUnderSm from "./BottomBarUnderSm";
...
const BottomBar = () => {
  ...
  return (
        <>
        <section className='sm:bg-[#FF624C] mb-8 hidden sm:block'>
            <Container>
                <section className="items-center justify-between font-[Montserrat] py-[26px] text-white font-bold leading-6 text-base flex">
