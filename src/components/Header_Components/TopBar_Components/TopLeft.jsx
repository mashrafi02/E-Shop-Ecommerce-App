...
const TopLeft = () => {
  return (
        <div className="top-left flex gap-x-[37.7px] sm:gap-[48px] px-2 sm:px-0 mb-2 sm:mb-0">
            <div className="address flex items-center gap-[8px] text-[#303030] font-[Montserrat] text-sm font-normal leading-5 relative after:content-[''] after:absolute after:w-px after:h-5 sm:after:h-8 after:bg-[#BFBFBF] after:right-[-24px] after:top-1/2 after:-translate-y-1/2">
